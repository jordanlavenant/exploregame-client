...
import type { Client, ClientOptions, RequestParams, Sink } from 'graphql-sse'
...
class SSELink extends ApolloLink {
  ...
  constructor(options: SSELinkOptions) {
    ...
    const { url, headers, httpLinkConfig } = options
    const { referrer, referrerPolicy } = httpLinkConfig?.headers || {}
